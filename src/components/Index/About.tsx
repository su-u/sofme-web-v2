    ...
    },
    {
      ...
      description: (
        <>
          ...
          <p>
            <strong>毎週水曜日午後6:45</strong>
            から部会を開いており、会員は参加が義務付けられています。（授業等がある場合はそちらを優先します。）
            部会では文化会での行事の人員を選出したり、設備購入等の議決を取ったりなどといった、重要な事を話し合います。
          </p>
          <p>
            また、年に２回ある大きなイベント、
            <strong>文化の祭典</strong>と<strong>津田沼祭</strong>
            では、サークルとして各自が作品を出品します。
